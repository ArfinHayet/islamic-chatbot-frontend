...
const CONTENT = {
  ...
  ur: {
    ...
    title: "شرائط و ضوابط",
    subtitle:
      "یہ شرائط وضاحت کرتی ہیں کہ آپ Noor AI کیسے استعمال کر سکتے ہیں اور اس اسلامی تعلیمی معاون سے کیا توقع رکھنی چاہیے۔",
    updated: "۱۶ مئی ۲۰۲۶",
    sections: [
      {
        title: "تعلیمی استعمال",
        body:
          "Noor AI سیکھنے اور غور و فکر کے لیے اسلامی معلومات فراہم کرتا ہے۔ یہ کسی مستند عالم، مفتی، امام، وکیل، ڈاکٹر یا دیگر پیشہ ور مشیر کا متبادل نہیں ہے۔",
      },
      {
        title: "صارف کی ذمہ داریاں",
        items: [
          "ایپ کو باادب اور قانونی طریقے سے استعمال کریں۔",
          "تیار کردہ جوابات کو ذاتی فتویٰ یا حتمی شرعی حکم کے طور پر نہ لیں۔",
          "حساس معاملات کی تصدیق مستند علماء اور قابلِ اعتماد ذرائع سے کریں۔",
          "سروس کے غلط استعمال، اسے متاثر کرنے، ریورس انجینئر کرنے یا اس پر غیر ضروری دباؤ ڈالنے کی کوشش نہ کریں۔",
        ],
      },
      {
        title: "AI سے تیار کردہ مواد",
        body:
          "جوابات AI کے ذریعے تیار یا معاون ہو سکتے ہیں اور ان میں غلطیاں، کمی یا علمی تعبیرات کا اختلاف ہو سکتا ہے۔ Noor AI مددگار بننے کی کوشش کرتا ہے، لیکن درستگی کی ضمانت نہیں دی جاتی۔",
      },
      {
        title: "دستیابی",
        body:
          "ہم کسی بھی وقت سروس کے حصوں کو اپ ڈیٹ، معطل، محدود یا بند کر سکتے ہیں۔ چیٹ، نماز کے اوقات یا دعاؤں جیسے فیچرز فریق ثالث کے سسٹمز یا نیٹ ورک کی دستیابی پر منحصر ہو سکتے ہیں۔",
      },
      {
        title: "رابطہ",
        body: "ان شرائط کے بارے میں سوالات کے لیے arfinhayet786@gmail.com پر رابطہ کریں۔",
      },
    ],
  },
  ar: {
    ...
    subtitle:
      "توضح هذه الشروط كيفية استخدامك لـ Noor AI وما يمكن توقعه من هذا المساعد التعليمي الإسلامي.",
    updated: "١٦ مايو ٢٠٢٦",
    sections: [
      {
        title: "الاستخدام التعليمي",
        body:
          "يقدم Noor AI معلومات إسلامية للتعلم والتدبر. وهو ليس بديلاً عن عالم مؤهل أو مفتٍ أو إمام أو محامٍ أو طبيب أو أي مستشار مهني آخر.",
      },
      {
        title: "مسؤوليات المستخدم",
        items: [
          "استخدم التطبيق باحترام وبما يوافق القانون.",
          "لا تعتمد على الإجابات المولّدة كفتاوى شخصية أو أحكام دينية نهائية.",
          "تحقق من المسائل الحساسة لدى أهل العلم الموثوقين والمصادر المعتمدة.",
          "لا تحاول إساءة استخدام الخدمة أو تعطيلها أو إجراء هندسة عكسية لها أو إثقالها بالطلبات.",
        ],
      },
      {
        title: "المحتوى المولّد بالذكاء الاصطناعي",
        body:
          "قد تكون الردود مولّدة أو مدعومة بالذكاء الاصطناعي وقد تحتوي على أخطاء أو نواقص أو اختلافات في الاجتهاد العلمي. يسعى Noor AI لتقديم المساعدة، لكن الدقة غير مضمونة.",
      },
      {
        title: "التوفر",
        body:
          "قد نقوم بتحديث أجزاء من الخدمة أو إيقافها مؤقتًا أو تقييدها أو إيقافها نهائيًا في أي وقت. قد تعتمد ميزات مثل المحادثة أو مواقيت الصلاة أو الأدعية على أنظمة أطراف ثالثة أو توفر الشبكة.",
      },
      {
        title: "التواصل",
        body: "للأسئلة حول هذه الشروط، تواصل معنا على arfinhayet786@gmail.com.",
      },
    ],
  },
};
