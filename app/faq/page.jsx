...
const CONTENT = {
  en: {
    ...
    sections: [
      ...
      },
      {
        ...
        body: "The app interface supports English, Bangla, Urdu, and Arabic. Chat answers may also be requested in any of these languages.",
      },
      {
  ...
  bn: {
    ...
    sections: [
      ...
      },
      {
        ...
        body: "অ্যাপ ইন্টারফেস ইংরেজি, বাংলা, উর্দু ও আরবি সমর্থন করে। চ্যাট উত্তরও এই ভাষাগুলোর যেকোনো একটিতে চাইতে পারেন।",
      },
      {
  ...
  ur: {
    ...
    sections: [
      ...
      },
      {
        ...
        body: "ایپ کا انٹرفیس انگریزی، بنگلہ، اردو اور عربی میں دستیاب ہے۔ چیٹ کے جوابات بھی ان میں سے کسی بھی زبان میں طلب کیے جا سکتے ہیں۔",
      },
      {
  ...
  ar: {
    ...
    subtitle: "إجابات عن الأسئلة الشائعة حول Noor AI والإرشاد الإسلامي والأدعية ومواقيت الصلاة واستخدام التطبيق.",
    sections: [
      {
        title: "ما هو Noor AI؟",
        body: "Noor AI مساعد إسلامي متعدد اللغات بالذكاء الاصطناعي يساعد المستخدمين على طرح الأسئلة وقراءة الأدعية اليومية والاطلاع على مواقيت الصلاة بالإنجليزية والبنغالية والأردية والعربية.",
      },
      {
        title: "هل يمكن لـ Noor AI إصدار الفتاوى؟",
        body: "لا. يمكن لـ Noor AI تقديم معلومات تعليمية، أما الفتاوى والأحكام الشخصية فيجب أخذها من علماء مؤهلين يفهمون ظروفك.",
      },
      {
        title: "ما اللغات المدعومة؟",
        body: "واجهة التطبيق تدعم الإنجليزية والبنغالية والأردية والعربية. ويمكن أيضًا طلب إجابات المحادثة بأي من هذه اللغات.",
      },
      {
        title: "من أين جُمعت الأدعية؟",
        body: "تحتوي صفحة الأدعية على مجموعة محلية منتقاة مع النص العربي والنطق والمصادر والمعاني المترجمة.",
      },
      {
        title: "لماذا يجب التحقق من الإجابات؟",
        body: "قد تحتوي الإجابات المولّدة بالذكاء الاصطناعي على أخطاء أو قد تغفل الخلافات العلمية. تحقق دائمًا من المسائل الدينية الحساسة لدى علماء موثوقين ومراجع معتمدة.",
      },
    ],
  },
};
