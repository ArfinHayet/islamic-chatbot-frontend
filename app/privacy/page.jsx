...
const CONTENT = {
  ...
  ar: {
    ...
    subtitle:
      "توضح هذه السياسة المعلومات التي يستخدمها Noor AI لتقديم تجربة التطبيق، وكيف ينبغي للمستخدمين التفكير في الخصوصية أثناء استخدام الخدمة.",
    updated: "١٦ مايو ٢٠٢٦",
    sections: [
      {
        title: "المعلومات التي تقدمها",
        body:
          "عند استخدام المحادثة، تُرسل الرسالة التي تكتبها إلى واجهة برمجة التطبيقات الخلفية ليتمكن Noor AI من توليد الرد. تجنّب مشاركة كلمات المرور أو المستندات الخاصة أو معلومات الدفع أو التفاصيل الشخصية شديدة الحساسية.",
      },
      {
        title: "تفضيلات التطبيق",
        body:
          "قد تُحفظ تفضيلات اللغة والسمة محليًا في متصفحك ليتذكر التطبيق التجربة التي اخترتها.",
      },
      {
        title: "بيانات الخدمة",
        items: [
          "قد يستخدم التطبيق معرّف مستخدم مولّدًا تلقائيًا لدعم جلسات المحادثة.",
          "قد تطلب ميزة مواقيت الصلاة بيانات التوقيت من خادم Noor AI.",
          "قد تصل المتصفحات وبرامج الزحف إلى الملفات العامة مثل manifest وsitemap وrobots.txt وllms.txt.",
        ],
      },
      {
        title: "أنظمة الأطراف الثالثة",
        body:
          "يُستضاف Noor AI ويُقدَّم عبر بنية تحتية للويب مثل Vercel، وقد يستخدم خدمات خلفية لمعالجة الطلبات. قد تتلقى تلك الأنظمة البيانات التقنية اللازمة لتشغيل التطبيق.",
      },
      {
        title: "التواصل",
        body: "للأسئلة المتعلقة بالخصوصية، تواصل معنا على arfinhayet786@gmail.com.",
      },
    ],
  },
};
